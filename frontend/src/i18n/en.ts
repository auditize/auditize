export default {
  ...
  log: {
    ...
    downloadLog: "Download log as JSON",
    entity: "Entity",
    list: {
      columnSelector: {
    ...
    filter: {
      ...
      save: "Save filter",
      saveChanges: "Save filter changes",
      saveAsNew: "Save filter as new",
    ...
    inlineFilter: {
      ...
      field: {
        ...
        actorExtraField: "this actor's {{field}}",
        ...
        resourceExtraField: "this resource's {{field}}",
        tag: "this tag",
